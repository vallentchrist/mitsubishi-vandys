<?php
  ...
  if (isset($_POST["kategori"]))
  {
    ...
    {
      $result = $conn->query("SELECT * FROM tb_harga WHERE merek = 'COLT DIESEL' AND kategori='$kategori' AND discontinue = 0");
    }    
    while ($row = $result->fetch_array())
    {
      ...
      $data .= '<div class="col-4 col-sm-3">
                <img src="' .BASE_URL.DS. 'assets/img/colt-diesel/' .$tipe. '.png" alt="Mitsubishi Colt Diesel" class="img-fluid" style="width: 200px">
