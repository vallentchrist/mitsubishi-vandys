    ...
    <div class="container">
      <div class="row p-2">
        ...
        <div class="col-6 col-lg-8 d-flex justify-content-center align-items-center" onclick="window.location='https://mitsubishimedan-vandys.id/'">
          <label class="text-uppercase text-center d-none d-sm-block label-sardana text-dark" style="cursor: pointer"><span class="mmc-bold">PT. Sardana IndahBerlian Motor</span> <br /> Jl. Jend Gatot Subroto No. 437 Medan</label>          
          <a href="<?=BASE_URL?>">            
